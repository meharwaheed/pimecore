...
<?= $this->areablock('newsletter', [
    'controlsTrigger' => 'fixed',
    'allowed' => ['nl-hero','nl-row','nl-grid','nl-headline'],
    'sorting' => ['nl-hero','nl-row','nl-grid','nl-headline']
]); ?>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="max-width: 500px;" class="responsive-table">
                <tr>
                    <td align="center" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
                        <?php echo $bottomLine; ?>
                        <br>
                        <a href="<?= $baseUrl . '/abmelden'; ?>" target="_blank" style="color: #666666; text-decoration: none;">Newsletter abmelden</a>
                    </td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
